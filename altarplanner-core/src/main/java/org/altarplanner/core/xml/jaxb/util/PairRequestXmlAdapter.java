...
public class PairRequestXmlAdapter
    extends XmlAdapter<PairRequestXmlAdapter.AdaptedPairRequest, PairRequest> {
  public static class AdaptedPairRequest {
    @XmlIDREF @XmlAttribute public Server server;
    @XmlIDREF @XmlAttribute public Server pairedWith;
  }
