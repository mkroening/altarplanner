...
public class PoiIO {
    ...
    public static void exportSchedule(Schedule schedule, File file, int columns) throws IOException {
        ...
        headerCell.setCellValue("Altar Plan: " +
                schedule.getPlanningWindow().getStart().format(DateTimeFormatter.ofLocalizedDate(FormatStyle.MEDIUM)) +
                " - " +
                schedule.getPlanningWindow().getEndInclusive().format(DateTimeFormatter.ofLocalizedDate(FormatStyle.MEDIUM)));
