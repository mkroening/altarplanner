...
class ScheduleTests {
    ...
    private final static LocalDate LAST_MONDAY = LocalDate.now().plusDays(DayOfWeek.MONDAY.getValue() - LocalDate.now().getDayOfWeek().getValue());
    ...
    void constructorFutureDraftTest() {
        ...
        assertEquals(LAST_MONDAY.getDayOfWeek(), lastSchedule.getFutureDraftMasses().get(0).getDateTime().getDayOfWeek());
        assertEquals(LAST_MONDAY.getDayOfWeek(), lastSchedule.getFutureDraftMasses().get(1).getDateTime().getDayOfWeek());
        ...
        assertEquals(LAST_MONDAY.getDayOfWeek(), middleSchedule.getFutureDraftMasses().get(0).getDateTime().getDayOfWeek());
